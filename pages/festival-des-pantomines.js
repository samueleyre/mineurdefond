...
function FestivalDesPantomines() {
    ...
    return <>
        ...
        <div style={{backgroundColor: "white"}}>
            <ProjectLayoutComponent bgColor="white" className="ProjectPage pb-10" subClassName="max-w-screen-lg m-auto">
                ...
                <div className="p-6 justify-center flex m-auto w-full">
                    <a className="justify-center flex" href="/documents/plan2024.pdf" target="_blank" rel="noreferrer">
                    <span className="p-4"
                ...
                <p className="text-xl pt-8 mb-6 pl-4 pr-4">
                    ...
                    <br/><br/>
                    Avec des concerts et des spectacles en pleine nature, le Festival des Pantomines est un événement
                    ...
                    Allant du jazz aux musiques d’inspiration voire de collectage traditionnel, du théâtre au spectacle
                    de marionnettes, nous passerons d'un versant à l'autre de la montagne et prendrons les chemins de
...
Touffe d’errance, c’est l’histoire de toutes ces personnes qu’elles ont rencontrées."
            ...
            <div className="py-10 text-center" style={{
                ...
                <p className="font-bold text-4xl mb-6 text-center mt-16 italic" style={{color: "grey", lineHeight: "0.5rem"}}>
                    Infos pratiques
                </p>
