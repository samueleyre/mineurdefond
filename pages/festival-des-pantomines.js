    ...
    return <>
        ...
        <ProjectLayoutComponent bgColor="#e1ebee" >
            ...
            <div className="p-6 justify-center flex m-auto w-full">
                <a className="justify-center flex" href="/documents/plan2023.pdf" target="_blank" rel="noreferrer">
                    <span className="p-4"
...
"
                ...
                <FestivalEventV2Component
                        image="papanosh.webp"
                        title="Le Bal de Papanosh"
                        subtitle={"concert festif"}
                        title_font="font-cameo"
                        title_color="#a76a53"
                        place_and_time="Salle polyvalente de Planjo à Sainte-Foy-Tarentaise <br><br> 19h ouverture et initiation danse, 21h début du concert <br> Restauration sur place"
                        ...
                        <br><br>Un temps d’<b>initiation à des danses de groupe</b> sera proposé avant le concert."
            ...
            <div className="mobile:p-4 sm:pt-22 sm:pb-22 sm:pl-4 sm:pr-4 mb-24 flex flex-wrap justify-center">
                ...
                <FestivalEventV2Component
                    ...
                    title="Sonore Boréale"
                    subtitle="conte musical"
                    title_font="font-cameo"
                    title_color="#774091"
...
"
            ...
            <div class="p-6 justify-center flex m-auto w-full">
                <a class="justify-center flex" href="/documents/programme2023.pdf" target="_blank" rel="noreferrer">
                    <span class="p-4" style={{backgroundColor: "#242424", color: "white"}}>Télécharger le programme</span>
                    <img width="60px" src="/images/plan.webp" alt="le plan du festival"/>
                </a>
            </div>
